...
public class MaxPatrulla : MonoBehaviour
{
	[SerializeField] private DejarAFua df;
	[SerializeField] private GameObject salchicha;
	...
	private bool ReachedWayPoint()
	{
		...
		return Vector3.Distance(transform.position, new Vector3(currentTargetPosition.x, transform.position.y, currentTargetPosition.z)) <= minDistance;
	}
